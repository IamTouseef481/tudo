defmodule CoreWeb.Services.ImageUploader do
  @moduledoc false
  use Arc.Definition
  ...
  #  transform will call number of times which @versions have like in our case it will cal two times
  ...
  def transform(:original, {%{path: path}, _}) do
    case File.stat!(path) do
      %{size: file_size} ->
        ...
        case Core.Settings.get_tudo_setting_by(%{slug: "max_file_size"}) do
          nil ->
            :noaction

defmodule CoreWeb.Templates.EmailTemplates.InviteCmr do
  @moduledoc false
  def template("en", %{message: message, year: year}) do
    %{
      subject: "TUDO - Invitation",
      html_body: """
                              ...
                              <center>
                                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                                  <tr>
                                    ...
                                    <br>
                                      You have invited to TUDO app. #{message}
                                    <br>
                                    <br>
                                    </td>
                                  </tr>
  ...
  def template(_, %{message: message, year: year}) do
    %{
      subject: "TUDO - Invitation",
      html_body: """
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

defmodule CoreWeb.Templates.EmailTemplates.CreateJobConfirmedForBsp do
  @moduledoc false
  def template(
        "en",
        %{
    ...
    %{
      ...
      html_body: """
        ...
        * {
        ...
        <div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
        <p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"><span style="font-size: 12px;">You have received #{service_type} <a href="http://tudo.app/appointmentid" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank" title="TUDO Appointment ID">Appointment# #{job_id}</a> with Consumer #{cmr_first_name} #{cmr_last_name}, and has been assigned to your employee #{emp_first_name} #{emp_last_name}.</span></p>
        </div>
        </div>
        <!--[if mso]></td></tr></table><![endif]-->
        <!--[if (!mso)&(!IE)]><!-->

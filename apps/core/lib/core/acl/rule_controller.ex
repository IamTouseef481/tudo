...
defmodule Core.Acl.RuleController do
  #  @moduledoc false
  use AclWeb, :controller

  #  alias Acl.AclContext
  ...
  #
  #
  #  def check_rule(role, res, action, permission)do
  #
  ...
  #
  #
  #  def add_rule(role, res_, permission \\ 1, action \\ nil, condition \\ 1)do
  #

...
#  @doc false
#
#  def allow_access( %{__struct__: _} = rule) do
#
...
#  @doc false
#
#  def allow_access(conn, params) do
#
...
#  @doc false
#
#  def deny_access(conn, %{__struct__: _}  = rule) do
#
#    case RuleController.deny_rule(rule) do
#      true -> {:ok, :allowed}
#      false -> {:error, "rule not found, perhaps create new rule?"}
...
#  @doc false
#
#  def deny_access(conn, params) do
#
#    case RuleController.deny_rule(params) do
#      true -> {:ok, :allowed}
#      false -> {:error, "rule not found, perhaps create new rule?"}

defmodule Core.Repo.Migrations.CreatePaypalSubscriptionPlans do
  @moduledoc false
  use Ecto.Migration

  def change do
    create table(:paypal_subscription_plans) do
      add :slug, :string
      add :name, :string
      add :type, :string
    ...
    create index(:paypal_subscription_plans, [:country_id])
  end
end

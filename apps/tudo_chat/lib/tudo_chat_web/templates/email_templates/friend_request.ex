defmodule TudoChatWeb.Templates.EmailTemplates.FriendRequest do
  @moduledoc false
  def template("en", %{name: full_name} = _attr) do
    {year, _, _} = Date.utc_today() |> Date.to_erl()

    %{
      subject: "TUDO - Friend Request",
      html_body: """
        ...
        * {
        ...
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">Dear user,</p>
        ...
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">Thank you for choosing <a href="http://tudo.app" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank" title="TUDO.app">TUDO</a> and welcome onboard!</p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">#{full_name} sent you a friend request to start chat</p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"></p>
        <p style="line-height: 1.2; word-break: break-word; font-size: 10px; mso-line-height-alt: 12px; margin: 0;"><span style="font-size: 10px; color: #ff0000;"></span></p>
        </div>
        </div>
        <!--[if mso]></td></tr></table><![endif]-->
        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
  ...
  def template(_, %{name: full_name} = _attr) do
    {year, _, _} = Date.utc_today() |> Date.to_erl()

    %{
      subject: "TUDO - Account Activation",
      html_body: """
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        * {
        ...
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">Thank you for choosing <a href="http://tudo.app" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank" title="TUDO.app">TUDO</a> and welcome onboard!</p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">You are just one step away, use this One-time password (OTP) to complete your TUDO account activation process.</p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
        <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"></p>
        <p style="line-height: 1.2; word-break: break-word; font-size: 10px; mso-line-height-alt: 12px; margin: 0;"><span style="font-size: 10px; color: #ff0000;"></span></p>

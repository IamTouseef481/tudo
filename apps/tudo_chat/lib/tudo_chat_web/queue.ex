defmodule TudoChatWeb.Queue do
  @moduledoc false
  ...
  @type queue_attributes :: [
          ...
          | {:maximum_message_size, 1_024..262_144}
  ...
  @spec set_queue_attributes(queue_name :: binary, attributes :: queue_attributes) ::
  ...
  def get_queue_url(queue_name, opts \\ []) do
    params = opts |> format_regular_opts |> Map.put("QueueName", queue_name)
  ...
  @spec receive_message(queue_name :: binary, opts :: receive_message_opts) ::
          ExAws.Operation.Query.t()
  def receive_message(queue, opts \\ []) do
    {attrs, opts} = opts |> Keyword.pop(:attribute_names, [])

    {message_attrs, opts} = opts |> Keyword.pop(:message_attribute_names, [])
  ...
  @spec send_message(queue_name :: binary, message_body :: binary, opts :: sqs_message_opts) ::
          ExAws.Operation.Query.t()
  ...
  @spec send_message_batch(queue_name :: binary, messages :: [sqs_batch_message, ...]) ::
          ExAws.Operation.Query.t()
  ...
  def change_message_visibility(queue, receipt_handle, visibility_timeout) do
    request(queue, :change_message_visibility, %{
  ...
  defp request(queue, action, params) do
    ...
    %ExAws.Operation.Query{
      ...
      service: :sqs,
      action: action,
      parser: &ExAws.SQS.SweetXmlParser.parse/2
    }
  end
